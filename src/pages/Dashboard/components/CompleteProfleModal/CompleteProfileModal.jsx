...
const CompleteProfileModal = ({ isOpen, onClose }) => {
 ...
 const dispatch = useDispatch();
  ...
  const handleSubmit = async(e) => {
    ...
    if (!age || age < 12 || age > 120) return toast.error('Valid Age is required (12–120)');
    if (!gender) return toast.error('Gender is required');
    if (!weight || weight < 30 || weight > 300) return toast.error('Valid Weight is required (30–300 kg)');
    if (!height || height < 100 || height > 250) return toast.error('Valid Height is required (100–250 cm)');
    ...
    const profileData = Object.fromEntries(formData.entries());
        ...
        try {
          const { data } = await axiosInstance.post("/users/save-user", profileData);
    ...
    <>
      ...
      <div className={`modal-overlay ${isOpen ? 'active' : ''}`}>
        <div className="modal-container">
          ...
          <form id="profileForm" className="modal-body" onSubmit={handleSubmit} noValidate>
            {/* Basic Inputs */}
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="number" id="age" name="age" placeholder="Your age" min="12" max="120" />
              </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <div className="input-with-icon">
                  <input type="number" id="weight" name="weight_kg" placeholder="e.g. 68.5" min="30" max="300" />
              ...
              <div className="form-group">
                ...
                <div className="input-with-icon">
                  <input type="number" id="height" name="height_cm" placeholder="e.g. 175" min="100" max="250" />
            ...
            <div className="form-group">
              ...
              <div className="goal-cards">
                {['lose', 'maintain', 'gain', 'custom'].map((goalKey) => {
                  const goalInfo = {
                    lose: { icon: 'fas fa-weight', label: 'Lose Weight', desc: 'Burn fat and reduce body weight' },
                    maintain: { icon: 'fas fa-balance-scale', label: 'Maintain', desc: 'Keep your current weight' },
                    gain: { icon: 'fas fa-dumbbell', label: 'Gain Muscle', desc: 'Build strength and muscle mass' },
                    custom: { icon: 'fas fa-pen', label: 'Custom Goal', desc: 'Specify custom calorie target' }
                  }[goalKey];
